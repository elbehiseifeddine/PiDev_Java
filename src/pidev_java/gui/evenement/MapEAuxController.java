      ...
      public void inti(List<EventLoisir> Ea,EvenementController ec){
        ...
        /*for(int i=0;i<EventAux.size();i++){
            try {
                ...
                this.resize("ftp://user:123456789@192.168.1.52/"+EventAux.get(i).getImageE(), "C:\\Users\\seifeddine\\Documents\\NetBeansProjects\\PiDev_Java\\src\\pidev_java\\assets\\im"+EventAux.get(i).getImageE(), 30, 30);    
    ...
    private void showEAux(MouseEvent event) {
      ...
      for (int i=0;i<EventAux.size();i++){
                 try {
                     ...
                     Marker FormPlace= Marker.createProvided(Marker.Provided.BLUE).setPosition(FPlace)
                             .setVisible(true);
